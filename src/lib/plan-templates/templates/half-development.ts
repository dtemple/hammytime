    ...
    sessions: {
      lower_body: {
        ...
        exercises: [
          ...
          { name: 'Split squats', sets: 3, reps: 12, reps_unit: 'per_leg' },
          { name: 'Single-leg glute bridges', sets: 3, reps: 12, reps_unit: 'per_side' },
          { name: 'Side planks', sets: 3, reps: 40, reps_unit: 'seconds' },
        ],
      },
      upper_body: {
        ...
        exercises: [
          ...
          { name: 'Dead bugs', sets: 3, reps: 12, reps_unit: 'per_side' },
          { name: 'Plank', sets: 3, reps: 50, reps_unit: 'seconds' },
        ],
      },
    },
  },
